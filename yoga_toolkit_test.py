...
'''
type: WarriorII, Tree, Plank, ReversePlank, Childs, DownwardDog
'''
pose = YogaPose("LowLunge")
pose.initialDetect()
...
# # detect video path
video_path = f"{CWD}/yoga_toolkit/SampleVideo/LowLungePose/sample.mp4"
file_name = (video_path.split('/')[-1]).split('.')[0]
storage_path = f"{CWD}/yoga_toolkit/SampleVideo/LowLungePose/output/{file_name}.mp4"
