...
'''
type: WarriorII, Tree, Plank, ReversePlank, Childs, DownwardDog, LowLunge
'''
pose = YogaPose("SeatedForwardBend")
pose.initialDetect()
...
# # detect video path
video_path = f"{CWD}/yoga_toolkit/SampleVideo/SeatedForwardBendPose/sample.mp4"
file_name = (video_path.split('/')[-1]).split('.')[0]
storage_path = f"{CWD}/yoga_toolkit/SampleVideo/SeatedForwardBendPose/output/{file_name}.mp4"
